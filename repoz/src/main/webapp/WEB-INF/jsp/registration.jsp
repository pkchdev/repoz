...
<body>
	<div class="container">
		...
		<div id="loginbox"
			class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
			<div class="panel panel-default">
				...
				<div id="loginbox-panel" class="panel-body">
					<form:form method="POST" modelAttribute="user" name="form"
						...
						<spring:bind path="username">
							<div class="input-group ${status.error ? 'has-error' : ''} ">
								...
								<form:input type="text" path="username" required="required"
									class="form-control  ${empty username ? 'has-error' : '' } "
						...
						<a id="loginbox-button" class="btn btn-lg btn-warning btn-block"
